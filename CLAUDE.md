...
| ch8_sc5_c1 | 27 | 8/9/10 | 3 | 10s | 12s | ⚠ TIMEOUT. Okafor bedroom, Emeka + Mama Okafor. Double timeout at 480s each. Recovery checked 6 tiles, max 76% (below 92% threshold). Auto-moved to next clip. 42 credits burned with no output. Video may have needed >480s or Kling silently dropped it. Candidate for progressive wait timeout increase. No lip sync observations possible. | S1: "Where is she? Where did she go?" S2: "I did not know she was leaving, Emeka." S3: "You were here. You were in this house." |
...
**Emerging patterns (updated Session 27, 94 clips):**
