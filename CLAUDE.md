...
| ch4_sc4_c3 | 10 | 2/3/5 | 3 | 10s | 10s | ✓ No lip sync issues. Very low word count (~1 word/sec). Emeka stood up in S1 matching shot direction despite being seated in scene image. Body language on point. Multiple visual-state contradictions in prompt (handbag vs mug, near door vs sofa, ECU with back to camera) — unclear if 3rd Vision pass stripped them. | S1: "Come here." S2: "Emeka, I am tired." S3: "I said come here." |
